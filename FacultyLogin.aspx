<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FacultyLogin.aspx.cs" Inherits="LoginForm.FacultyLogin" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Label ID="Label1" runat="server" Text="Faculty Login"></asp:Label>
            <div style="width: 354px; top: 16px; left: 301px; height: 236px; margin-left: 80px; color:blue;" class="col-6 cols1">
                ...
                <asp:Button ID="login" runat="server" Text="Login" CssClass="btn btn-primary" BorderStyle="Groove" BackColor="#6699ff" OnClick="login_Click"/>  <asp:Button ID="signup" runat="server" Text="Sign Up" cssclass="btn btn-primary" BackColor="#6699ff" BorderStyle="Groove" OnClick="signup_Click"/>
