<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="LoginForm.ResetPassword" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <div style="width: 330px; top: 16px; left: 304px; height: 318px; margin-left: 80px; color:blue;" class="col-6 cols1">
                <asp:Table ID="Table2" runat="server" BorderStyle="None" Height="306px" Width="344px">
                    <asp:TableRow>
                        <asp:TableCell><asp:TextBox ID="TextBox1" runat="server" placeholder="Username" CssClass="form-control" Width="299px" Height="45px"></asp:TextBox>  </asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell><asp:TextBox ID="TextBox2" runat="server" placeholder="NewPassword" CssClass="form-control" Width="299px" Height="45px" TextMode="Password"></asp:TextBox>  </asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                    ...
                    <asp:TableRow>
                        <asp:TableCell><asp:TextBox ID="SAns" runat="server" placeholder="SecurityAnswer" CssClass="form-control" Width="299px" Height="45px" TextMode="Password"></asp:TextBox>  </asp:TableCell>
                    </asp:TableRow>
                    </asp:Table>
            </div>
            <br />
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="RPwd" runat="server" Text="ResetPassword" CssClass="btn btn-primary" BorderStyle="Groove" BackColor="#6699ff" Width="130" OnClick="RPwd_Click" />
     </form>
</body>
</html>
